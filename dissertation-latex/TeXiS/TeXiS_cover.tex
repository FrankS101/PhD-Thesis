...
\def\programaDoctoradoVal{}
\newcommand{\programadoctorado}[1]{
\def\programaDoctoradoVal{#1}
}

% Departamento
\def\departamentoVal{}
\newcommand{\departamento}[1]{
\def\departamentoVal{#1}
}
...
% Tribunal
\def\tribunalPortadaVal{}
\newcommand{\tribunalPortada}[1]{
\def\tribunalPortadaVal{#1}
}

% Informes
\def\informesPortadaVal{}
\newcommand{\informesPortada}[1]{
\def\informesPortadaVal{#1}
}
...
% Cuarto subtítulo de la segunda portada
\def\textoCuartoSubtituloPortadaVal{%
\textit{Tribunal de la tesis / Thesis Committee}  \\ [0.3em]
\textbf{\\ \tribunalPortadaVal}
}
\newcommand{\textoCuartoSubtituloPortada}[1]{
\def\textoCuartoSubtituloPortadaVal{#1}
}

% Quinto subtítulo de la segunda portada
\def\textoQuintoSubtituloPortadaVal{%
\textit{Evaluadores externos / External Reviewers}  \\ [0.3em]
\textbf{\\ \informesPortadaVal}
}
\newcommand{\textoQuintoSubtituloPortada}[1]{
\def\textoQuintoSubtituloPortadaVal{#1}
}

% Tercer subtítulo de la segunda portada
\def\textoTercerSubtituloPortadaVal{%
\textbf{\programaDoctoradoVal} \\[0.2em]
\textbf{\departamentoVal} \\[0.2em]
\textbf{\facultadVal} \\[0.2em]
\textbf{\institucionVal}
}
\newcommand{\textoTercerSubtituloPortada}[1]{
\def\textoTercerSubtituloPortadaVal{#1}
}
...
\else
\noindent 
%Este documento está preparado para ser imprimido a doble
cara.
\fi
\end{center}
\end{small}
...
\begin{large}
\begin{center}
\textoTercerSubtituloPortadaVal\\[0.2em]
    \mbox{ }  \\
\textbf{\fechaPublicacionVal}
\end{center}
\end{large}
...
\begin{large}
\begin{center}
\textoCuartoSubtituloPortadaVal\\[0.2em]
    \mbox{ }  \\
\textoQuintoSubtituloPortadaVal\\[0.2em]
\end{center}
\end{large}
