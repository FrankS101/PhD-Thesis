...
%%%
%% COMANDO PARA CREAR LA BIBLIOGRAFÍA DE CADA CAPÍTULO.
%% CONTIENE TODO EL CÓDIGO LaTeX
%%%

\newcommand{\makeChapterBib}[1]{
...
} %\newcommand{\makeChapterBib}

% Para usar varios ficheros de bibliografia

%\newcites{BibMachuca}{Publications}
...
%\endgroup
%
%\begin{btSect}[TeXiS/TeXiS]{\ficherosBibliografia}
%\spanishdeactivate{~}
%\btPrintCited
%\end{btSect}
%
%
%} %\newcommand{\makeBibTopic}
...
\addcontentsline{toc}{chapter}{\titBib}
\else
\addcontentsline{toc}{part}{\titBib}
\fi
\fi
% Añadimos también una etiqueta, para poder referenciar el número
% de página en el que comienza
...
%\begin{btSect}[TeXiS/TeXiS]{\ficherosBibliografia}
\begin{btSect}[apalike2]{\ficherosBibliografia}
%\spanishdeactivate{~}
\btPrintCited
\end{btSect}
