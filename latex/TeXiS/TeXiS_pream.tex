...
% Para  poder poner  "subfiguras"

\usepackage{subfigure}

%Si queremos que en \listoffigures salgan los caption de cada subfloat, contenidos dentro del figure, poner lo siguiente, por ejemplo, en el preámbulo:

%\renewcommand{\thesubfigure}{\thefigure.\arabic{subfigure}}
%\captionsetup[subfigure]{labelformat=simple,labelsep=colon,
%listofformat=subsimple,lofdepth=2}
%\makeatletter
%\renewcommand{\p@subfigure}{}
%\makeatother

% El  paquete anterior  (subfig) tiene un  problema  cuando se  utiliza en  los
...
\usepackage{lmodern}
% Muy importante la línea anterior para asegurar que el pdf generado tiene fuentes de alta calidad
...
% Paquete  que permite poner grandes comentarios
...
%% The ams-latex package provides various useful mathematical utilities, 
% like reference to equations
\usepackage{amsmath}


%\usepackage{pxfonts,txfonts}

% Paquete para poner bibliografia en cada capitulo
...
% Para usar varios ficheros de bibliografia
